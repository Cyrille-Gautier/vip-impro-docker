...
class Magsy_Post_Big_3_Module extends Magsy_Post_Base_Module {

  public function __construct() {
		parent::__construct(
			'magsy_module_post_big_3',
			esc_html__( 'Magsy Module: Big 3 Posts', 'magsy' ),
			array( 'description' => esc_html__( 'Three big posts.', 'magsy' ) )
		);
  }
      ...
      <div class="row">
        <?php while ( $this->data->have_posts() ) : $this->data->the_post(); ?>
          <div class="col-md-6 col-lg-4">
            <article <?php post_class( 'post post-medium' ); ?>>
