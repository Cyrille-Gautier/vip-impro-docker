...
class Magsy_Slider_Big_Module extends Magsy_Post_Base_Module {

  public function __construct() {
		parent::__construct(
			'magsy_module_slider_big',
			esc_html__( 'Magsy Module: Big Slider', 'magsy' ),
			array( 'description' => esc_html__( 'A big slider of posts.', 'magsy' ) )
		);
  }
  ...
  public function widget( $args, $instance ) {
    ...
    <div class="module slider big owl nav-white<?php echo esc_attr( $autoplay ? ' autoplay' : '' ); ?>">
