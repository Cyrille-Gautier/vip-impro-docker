...
class Magsy_Slider_Thumbnail_Module extends Magsy_Post_Base_Module {

  public function __construct() {
		parent::__construct(
			'magsy_module_slider_thumbnail',
			esc_html__( 'Magsy Module: Thumbnail Slider', 'magsy' ),
			array( 'description' => esc_html__( 'A slider of posts with thumbnails.', 'magsy' ) )
		);
  }
  ...
  public function widget( $args, $instance ) {
    ...
    <div class="module slider thumbnail owl<?php echo esc_attr( $autoplay ? ' autoplay' : '' ); ?>">
      <?php while ( $this->data->have_posts() ) : $this->data->the_post();
        ...
        <article <?php post_class( 'post lazyload visible' ); ?> data-bg="<?php echo esc_url( $bg_image[0] ); ?>" data-dot="<img class='lazyload' data-src='<?php echo esc_url( get_the_post_thumbnail_url( get_the_ID(), 'thumbnail' ) ); ?>'>">
